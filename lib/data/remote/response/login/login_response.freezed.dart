...
class _$_LoginResponse extends _LoginResponse {
  const _$_LoginResponse(
      {this.user, this.status, this.statusCode, this.message, this.token})
      : super._();
  ...
  @override
  String toString() {
    return 'LoginResponse(user: $user, status: $status, statusCode: $statusCode, message: $message, token: $token)';
  }
