...
String formatToIdr(
  ...
  return NumberFormat.simpleCurrency(
          locale: 'id_ID', decimalDigits: decimalDigits, name: "Rp ")
      .format(value ?? 0);
}
...
String inCaps(String? value) => value != null && value.isNotEmpty
...
String removeIdrFormat(String? value) {
  return value?.replaceAll(RegExp(r"[Rp.]"), "") ?? '0';
}
